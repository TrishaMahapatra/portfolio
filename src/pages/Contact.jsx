...
function Contact() {
  ...
  return (
    <Element name='contact' className='w-full h-150 lg:h-90 bg-slate-100 shadow-lg flex flex-col lg:flex-row justify-between'>
        ...
        <div className='w-full lg:w-2/5 order-2 lg:order-1 p-4 sm:p-6 lg:p-10 h-2/5 lg:h-93 z-10 flex flex-col gap-2 lg:gap-5'>
        ...
        <form ref={form} method='post' className='w-full order-1 lg:order-2 lg:w-2/5 p-4 lg:p-5 h-3/5 lg:h-93 z-10 flex flex-col justify-center items-center bg-[#393a3f] lg:bg-none'>
            ...
            <input type="text" name="name" id="name" placeholder='Name' value={formData.name} onChange={handleChange} className='bg-white w-full sm:w-1/2 lg:w-2/3 p-2 rounded outline-0' />
            <input type="text" name="email" id="email" placeholder='Email' value={formData.email} onChange={handleChange} className='bg-white w-full sm:w-1/2 lg:w-2/3 p-2 rounded outline-0 mt-2' />
            <input type="text" name="subject" id="subject" placeholder='Subject' value={formData.subject} onChange={handleChange} className='bg-white w-full sm:w-1/2 lg:w-2/3 p-2 rounded outline-0 mt-2' />
            <textarea type="text" name="message" id="message" rows={3} placeholder='Message' className='bg-white w-full sm:w-1/2 lg:w-2/3 p-2 rounded outline-0 mt-2' value={formData.message} onChange={handleChange}/>
            {/* <br /> */}
