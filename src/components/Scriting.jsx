    ...
    <Element name='scripting' className='h-full w-screen p-4'>
      ...
      <div className='w-full overflow-x-scroll'>
        <div className='flex justify-around mt-4 gap-4'>
          <img src="/scripting/scripting-1.png" alt="" srcset="" className='rounded-xl' />
          <img src="/scripting/scripting-2.png" alt="" srcset="" className='rounded-xl' />
          <img src="/scripting/scripting-3.png" alt="" srcset="" className='rounded-xl' />
          <img src="/scripting/scripting-4.png" alt="" srcset="" className='rounded-xl' />
          <img src="/scripting/scripting-5.png" alt="" srcset="" className='rounded-xl' />
        </div>
      </div>
    </Element>
  )
